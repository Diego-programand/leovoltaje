  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-gray-50 to-white">

          {/* Patrón de fondo técnico (Cuadrícula) */}
          ...
          {/* Contenido de la sección - Usamos relative z-10 para asegurar que esté sobre el fondo */}
          <div className="container relative z-10 mx-auto px-4">

            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-primary-2 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {deliverables.map((deliverable, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-md hover:shadow-xl transition-all border-2 border-gray-100 hover:border-primary-3 hover:-translate-y-1"
                  >
        ...
        <ServiceCTA
          icons={<Ruler className="w-12 h-12" />}
          title="¿Necesitas Planos Certificados?"
          description="Cotiza tu proyecto hoy y recibe una propuesta técnica detallada con tiempos de entrega y costos."
          ctaText="Cotizar Ahora"
          whatsappMessage="Hola, necesito cotizar el diseño de planos eléctricos."
        />
      </main>
