  ...
  return (
    <>
      ...
      <main className="bg-white">
        ...
        <section className="py-24 bg-primary-5 text-white overflow-hidden relative">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <motion.a
                ...
                className="inline-flex items-center gap-6 bg-primary-3 text-white px-12 py-6 rounded-lg font-bold text-xl shadow-2xl hover:bg-black hover:gap-8 transition-all"
              >
                Contactar Ahora
                <ChevronRight />
              </motion.a>
