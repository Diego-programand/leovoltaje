    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                ...
                <section className="py-20 bg-primary-5 text-white">
                    <div className="container mx-auto px-4">
                ...
                <section className="py-24 bg-white relative bg-gradient-to-br from-primary-3 to-primary-4 p-10 lg:p-20 text-center text-white shadow-2xl relative overflow-hidden">
