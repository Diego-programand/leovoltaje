  ...
  return (
    <>
      ...
      <main className="bg-white">
        ...
        {/* CTA - Ultra Moderno */}
        <section className="py-20 bg-gradient-to-r from-slate-700 to-slate-900 rounded-[0rem] p-12 text-center text-white relative overflow-hidden">
          <div className="container mx-auto">
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-100" />
              <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white text-slate-700 px-8 py-4 rounded-full font-black text-lg hover:bg-blue-50 transition-all shadow-xl hover:scale-105 active:scale-95"
                >
