                    ...
                    <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-8">
                                    <div className="flex items-start gap-5">
                                        <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-primary-2 flex items-center justify-center shadow-[0_0_15px_rgba(56,28,227,0.4)]">
                                    ...
                                    <div className="flex items-start gap-5">
                                        <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-primary-2 flex items-center justify-center border border-white/10 hover:border-primary-1 transition-colors">
                                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="p-10 md:p-14 lg:w-3/5 bg-white">
                            <form onSubmit={handleWhatsAppRedirect} className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    className="group inline-flex items-center gap-3 bg-gradient-to-r from-primary-4 to-primary-4 hover:from-primary-3 hover:to-primary-3 text-white px-8 py-4 rounded-full font-bold text-base sm:text-lg transition-all transform hover:scale-105 shadow-2xl hover:shadow-primary-1/50 transition-ease-in-out"
                                >
                                    {/* WhatsApp Icon */}
                                    <svg
